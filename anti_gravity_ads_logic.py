    ...
    def ad_summary(ad, title=""):
        ...
        if media_url:
            ...
            if media_type == 'video':
                ...
                proxy_url = f"/api/v1/image-proxy?url={urllib.parse.quote(media_url)}"
                thumb_md = f"<img src='{proxy_url}' style='width: 150px; border-radius: 8px;' alt='ad_thumbnail' referrerpolicy='no-referrer' />"
...
[해당하는 소재의 미디어썸네일을 함께 배치하며 분석 설명...]
